...
class pointer_map : public std::map<_Key, void*, _Compare>
{
public:
  typedef std::map<_Key, void*, _Compare>  super_type;
  ...
  public:
    ...
    iterator (void) {;};
    iterator (const typename super_type::iterator &_s) : s(_s) {;};
    ...
    typename super_type::iterator s;
  };
